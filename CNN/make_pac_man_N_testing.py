...
def create_illusory_contour_dataset(save_dir):
    ...
    arc_lengths = [310, 270, 310, 320]  # Keep the arc lengths constant
    ...
    for i in range(1,num_images):
        img = Image.new('RGB', (canvas_size, canvas_size), (128, 128, 128))
        
        pac_man_angles = np.random.randint(0, 360, 4)  # Randomize the angles here
        ...
        filename = f'illusory_contour_{i+1}.png'
